...
const fallback: Record<Category, Pick<PortfolioItem, 'id' | 'title' | 'company' | 'description' | 'tags' | 'image' | 'category'>[]> = {
  ...
  ai: [
    ...
    { id: 'konnect-ai', title: 'Konnect AI', company: 'Falcon Hackathon Winner · LablabAI', description: '1st place at LablabAI Falcon Hackathon. AI networking tool built in 48 hours among 200+ teams.', tags: ['AI', 'Hackathon', '1st Place'], image: projectImage('konnect-ai'), category: 'ai' },
    { id: 'volund-ai', title: 'Volund AI', company: 'Enterprise AI Platform', description: 'Enterprise MLOps platform that cut deployment time by 80%. Roadmap, pricing, and positioning for B2B AI.', tags: ['Enterprise', 'MLOps', 'B2B SaaS'], image: projectImage('volund-ai'), category: 'ai' },
