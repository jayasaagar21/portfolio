...
const hardcoded: Record<string, { title: string; company: string; role: string; timeline: string; platform: string; overview: string; problem: string; solution: string; features: { title: string; description: string }[]; metrics: { value: string; label: string }[]; technologies: string; learnings: string; image: string; video?: string }> = {
  ...
  'konnect-ai': {
    title: 'Konnect AI',
    company: 'Falcon Hackathon Winner · LablabAI',
    role: 'Product Lead',
    timeline: '48 hours',
  ...
  'volund-ai': {
    title: 'Volund AI',
    company: 'AI Innovation Project',
    role: 'Product Manager',
    timeline: '5 months',
    platform: 'Cloud Platform',
    overview: 'Enterprise-grade AI development platform simplifying building, deploying, and monitoring AI models for business.',
    problem: 'Companies cannot move AI from experiment to production due to infrastructure complexity and monitoring gaps.',
    solution: 'End-to-end MLOps with automated deployment, versioning, monitoring, and explainability.',
    features: [
      { title: 'One-Click Deployment', description: 'Simplified production deployment' },
      { title: 'Model Versioning', description: 'Automatic iteration tracking with rollback' },
      { title: 'Performance Monitoring', description: 'Real-time accuracy, latency, and drift dashboards' },
      { title: 'Explainability', description: 'Built-in SHAP and LIME integration' },
    ],
